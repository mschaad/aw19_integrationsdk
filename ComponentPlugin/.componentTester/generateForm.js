...
componentDescriptor = [{"name":["lat"],"category":["input-only"],"type":["Decimal"]},{"name":["lng"],"category":["input-only"],"type":["Decimal"]},{"name":["title"],"category":["input-only"],"type":["Text"]},{"name":["displaySummary"],"category":["input-only"],"type":["Boolean"]},{"name":["displayHeader"],"category":["input-only"],"type":["Boolean"]},{"name":["darkySkyConnectedSystem"],"category":["input-only"],"type":["ConnectedSystem"]}];
var defaultValues = {"height":["auto"],"lat":[38.963517],"lng":[-77.36038],"title":["Weather in Reston, VA"],"displaySummary":[true],"displayHeader":[true],"darkySkyConnectedSystem":[{"key":"GetAuth","response":{"authKey":"1555438441_bf78d3c16a58dbf76ad6c0a01e29d855"}}]};
